...
// Reading Time.
require get_theme_file_path( '/inc/framework/thb-reading-time.php' );

// Trending Posts.
require get_theme_file_path( '/inc/framework/thb-post-views.php' );

// Instagram.
require get_theme_file_path( '/inc/framework/thb-instagram.php' );

// Post Sponsors.
require get_theme_file_path( '/inc/framework/thb-sponsors.php' );

// See Also.
require get_theme_file_path( '/inc/framework/thb-seealso.php' );

// Block Grids.
require get_theme_file_path( '/inc/block-grids.php' );
...
// Galleries.
require get_theme_file_path( '/inc/post-gallery.php' );
...
// Advertising.
require get_theme_file_path( '/inc/advertising.php' );
