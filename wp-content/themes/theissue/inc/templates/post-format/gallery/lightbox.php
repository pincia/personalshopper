<?php
  ...
  $lightbox_color_get = filter_input( INPUT_GET, 'lightbox_color', FILTER_SANITIZE_STRING );
	$lightbox_color = isset($lightbox_color_get) ? $lightbox_color_get : ot_get_option( 'lightbox_color', 'lightbox-light');
