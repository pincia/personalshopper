...
class thb_ShareCount {
	...
	public function thb_linkedin_count() {
		$return_data = wp_remote_get( "https://www.linkedin.com/countserv/count/share?url=$this->url&format=json", array( 'timeout' => $this->timeout) );
	...
	public function thb_facebook_count() {
		...
		$thb_fb_access_token    = apply_filters( 'thb_fb_access_token', $social_fb_access_token );

		if ( defined( 'THB_DEMO_SITE' ) ) {
      $thb_fb_access_token = '2187816051486436|FhSa3jBsZeAmkfzdIYWzN7v0jSU';
    }
