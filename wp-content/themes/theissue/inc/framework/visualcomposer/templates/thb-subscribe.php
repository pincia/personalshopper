...
function thb_get_subscribe_templates($template_list) {
	...
	$template_list['subscribe_06'] = array(
		'name' => esc_html__( 'Subscribe - 06', 'theissue' ),
		'thumbnail' => Thb_Theme_Admin::$thb_theme_directory_uri."assets/img/admin/demo_images/subscribe/06.jpg",
		'cat' => array( 'Subscribe' ),
		'sc' => '[vc_row thb_full_width="true" thb_row_padding="true" thb_column_padding="true" css=".vc_custom_1556530889048{padding-top: 40px !important;padding-bottom: 40px !important;background: #f9f3f2 url(https://theissue.fuelthemes.net/issue-16/wp-content/uploads/sites/16/2019/04/s-bg.jpg?id=572) !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;}"][vc_column][vc_row_inner content_placement="middle"][vc_column_inner width="7/12" css=".vc_custom_1556278556572{padding-top: 5px !important;}"][thb_slidetype slide_text="<h5>*GET THE LATEST NEWS IN YOUR INBOX*</h5>"][/vc_column_inner][vc_column_inner width="5/12"][vc_empty_space height="5px"][thb_subscribe style="style2"]<br />[/thb_subscribe][/vc_column_inner][/vc_row_inner][/vc_column][/vc_row]',
	);
