...
vc_map( array(
	...
	'params' => array(
		array(
			...
			'value'		 => '<h2>Unleash creativity with the powerful tools of *The Issue;Your Custom Content*</h2>',
			'description'=> '
			...
			Text separator is <b>;</b> for example: <strong>*The Issue; Your Custom Content*</strong>',
			"admin_label" => true,
		),
		array(
			"type" => "colorpicker",
...
vc_map( array(
	...
	'params' => array(
		array(
			...
			'value'		 => '<h2>*Unleash creativity with the powerful tools of The Issue, Your Custom Contents*</h2>',
...
vc_map( array(
	...
	"params"	=> array(
      ...
      "description" => esc_html__( "Instagram username to retrieve photos from.", 'theissue' ),
		...
		array(
      "type" => "textfield",
      "heading" => esc_html__( "Instagram Access Token", 'theissue' ),
      "param_name" => "access_token",
      "description" => esc_html__( "Instagram Access Token.", 'theissue' ),
			"dependency" => Array('element' => "type", 'value' => array('instagram')),
	  ),
		array(
...
vc_map( array(
	...
	"params"	=> array(
		array(
		    ...
		    "admin_label" => true,
				...
				"options" => array(
					...
					'style6' 				=> Thb_Theme_Admin::$thb_theme_directory_uri."/assets/img/admin/post_carousel/style6.png"
				),
		...
		array(
			...
			"std" => "3",
			"description" => esc_html__( "Select the layout.", 'theissue' ),
			"dependency" => Array('element' => "style", 'value' => array('style1', 'style2', 'style4', 'style5', 'style6'))
		),
		array(
	    "type" => "loop",
	    "heading" => esc_html__( "Post Source", 'theissue' ),
	...
	"params"	=> array(
      ...
      "admin_label" => true,
			"options" => array(
				...
				'style23' 			=> Thb_Theme_Admin::$thb_theme_directory_uri."/assets/img/admin/post_grid_styles/style23.png",
			),
	  ),
		array(
			"type" => "checkbox",
			...
			"description" => esc_html__( "You can toggle Excerpts using this checkbox.", 'theissue' ),
			"dependency" => Array('element' => "style", 'value' => array('style1-left', 'style1-center', 'style2', 'style19', 'style21', 'style22', 'style23'))
		),
	  array(
      "type" => "dropdown",
      "heading" => esc_html__( "Columns", 'theissue' ),
      ...
      "description" => esc_html__( "Select the layout of the posts.", 'theissue' ),
	  	"dependency" => Array('element' => "style", 'value' => array('style1-left','style1-center', 'style3', 'style4','style7','style9','style10','style11','style12','style14', 'style16', 'style20', 'style21', 'style22', 'style23'))
	  ),
	  array(
      "type" => "loop",
      "heading" => esc_html__( "Post Source", 'theissue' ),
...
vc_map( array(
	...
	'params' => array(
		array(
			...
			'value'		 => '<h2>*The Issue;Your Custom Contents*</h2>',
			'description'=> 'Enter the content to display with typing text. <br />
			Text within <b>*</b> will be animated, for example: <strong>*Sample text*</strong>. <br />
			Text separator is <b>;</b> for example: <strong>*The Issue; Your Custom Content*</strong> which will create new lines at ;',
			"admin_label" => true,
		),
		array(
			"type" => "dropdown",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"dependency" => Array('element' => "style", 'value' => array('style4', 'style5', 'style6', 'style7', 'style8', 'style9'))
		),
		array(
	  	'type' 					=> 'colorpicker',
	  	'heading' 			=> esc_html__( 'Background Color', 'theissue' ),
	  	'param_name' 		=> 'bg_color',
	  	'description' 	=> esc_html__( 'Background color of the title.', 'theissue' ),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
      "type" => "textfield",
      "heading" => esc_html__( "Twitter Username", 'theissue' ),
      "param_name" => "username",
      "admin_label" => true,
      "description" => esc_html__( "Twitter username to retrieve tweets from.", 'theissue' )
	  ),
		array(
		  "type" => "textfield",
