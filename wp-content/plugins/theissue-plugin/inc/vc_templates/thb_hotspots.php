        ...
        <div class="thb-hotspot-tooltip">
          <div class="thb-hotspot-tooltip-inner <?php if ($spot->Product && thb_wc_supported() ) { ?>thb-product-popup<?php }?>">
            <?php if ($spot->Product && thb_wc_supported() ) { ?>
              ...
              <?php if (!$product_loop->found_posts) { ?><p><?php esc_html_e('Product Not Found', 'theissue' ); ?></p><?php } ?>
            <?php } else { ?>
              <?php if ($spot->Title) { ?><h6><?php echo esc_html($spot->Title); ?></h6><?php } ?>
              <?php if ($spot->Message) { ?><p><?php echo esc_html($spot->Message); ?></p><?php } ?>
            <?php } ?>
          </div>
        </div>
      </div>
