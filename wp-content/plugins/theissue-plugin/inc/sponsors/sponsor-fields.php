...
?>
	<div class="form-field term-url-wrap">
		<label for="tag-url"><?php esc_html_e( 'Sponsor URL:', 'theissue' ); ?></label>
		<input name="thb_sponsor_url" id="tag-url" type="text" value="" size="40">
		<p><?php esc_html_e( 'The URL that sponsor links to.', 'theissue' ); ?></p>
	</div>
	<div class="form-field thb-sponsor-logo-wrap">
		<label><?php esc_html_e( 'Sponsor Logo', 'theissue' ); ?></label>
		...
		<p><?php esc_html_e( 'Upload your logo for the sponsor here.', 'theissue' ); ?></p>
	</div>
	...
	<table class="form-table">
		<tbody>
			<tr class="form-field term-url-wrap">
				<th scope="row"><label for="thb_sponsor_url"><?php esc_html_e( 'Sponsor URL', 'theissue' ); ?></label></th>
							<td><input name="thb_sponsor_url" id="thb_sponsor_url" type="text" value="<?php echo esc_attr( $thb_sponsor_logo_url ); ?>" size="40">
				<p class="description"><?php esc_html_e( 'You can link Sponsor logo to this url.', 'theissue' ); ?></p></td>
			</tr>
